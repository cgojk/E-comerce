...
const[menuOpen,setMenuOpen]= useState(false);
 // close the menu when clicking outside
  ...
  function handleLinkClick(){
    ...
    return (
<section className="navigation-section overlay active">
...
<header className="header ">
    <div className="header__inner">
            ...
            >
            {menuOpen ? <img src={closeIcon} alt="Close Icon" /> : <img src={hamburger} alt="Hamburger Menu Icon" />}
            </button>
        ...
        <nav className="navigation" aria-label="homepage Navigation">
                ...
                <ul className={`nav__list ${menuOpen ? "open" : ""}`}>
                    {/* <li className="nav-logo">
                        ...
                        <img src={logo} className="mobile-logo nav-logo" alt="a pair of sneakers shoes" />
